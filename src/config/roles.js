...
const PERMISSIONS = {
  ...
  // Loan Plan permissions
  CREATE_LOAN_PLAN: 'create:loan_plan',
  VIEW_LOAN_PLANS: 'view:loan_plans',
  UPDATE_LOAN_PLAN: 'update:loan_plan',
  DELETE_LOAN_PLAN: 'delete:loan_plan',
  MANAGE_LOAN_PLANS: 'manage:loan_plans',

  // Membership Plan permissions
  PURCHASE_MEMBERSHIP_PLAN: 'purchase:membership_plan',
  VIEW_OWN_MEMBERSHIP_PLANS: 'view:own_membership_plans',
  VIEW_ALL_MEMBERSHIP_PLANS: 'view:all_membership_plans',
  CANCEL_MEMBERSHIP_PLAN: 'cancel:membership_plan',
  MANAGE_MEMBERSHIP_PLANS: 'manage:membership_plans',
};
...
const ROLE_PERMISSIONS = {
  [ROLES.ADMIN]: [
    ...
    // Loan Plan Management (Full Access)
    PERMISSIONS.CREATE_LOAN_PLAN,
    PERMISSIONS.VIEW_LOAN_PLANS,
    PERMISSIONS.UPDATE_LOAN_PLAN,
    PERMISSIONS.DELETE_LOAN_PLAN,
    PERMISSIONS.MANAGE_LOAN_PLANS,

    // Membership Plan Management (Full Access)
    PERMISSIONS.VIEW_ALL_MEMBERSHIP_PLANS,
    PERMISSIONS.MANAGE_MEMBERSHIP_PLANS,
  ],
  ...
  [ROLES.SELLER]: [
    ...
    // Membership Plans (Seller Access)
    PERMISSIONS.PURCHASE_MEMBERSHIP_PLAN,
    PERMISSIONS.VIEW_OWN_MEMBERSHIP_PLANS,
    PERMISSIONS.CANCEL_MEMBERSHIP_PLAN,
  ],
  ...
  [ROLES.COOPERATIVE_ADMIN]: [
    ...
    // Loan Plan Management (Cooperative Level)
    PERMISSIONS.CREATE_LOAN_PLAN,
    PERMISSIONS.VIEW_LOAN_PLANS,
    PERMISSIONS.UPDATE_LOAN_PLAN,
    PERMISSIONS.DELETE_LOAN_PLAN,
    ...
    // Membership Plan Management (Cooperative Level)
    PERMISSIONS.VIEW_ALL_MEMBERSHIP_PLANS,
    PERMISSIONS.MANAGE_MEMBERSHIP_PLANS,
  ],
